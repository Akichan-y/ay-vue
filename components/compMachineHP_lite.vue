    ...
    >
      <v-container class="my-0 py-0 grey lighten-5">
        ...
        <v-row justify="center" class="mt-2">
          <div
            class="mt-0 green-circle btnLamp_lite"
          ...
          <div
            class="mt-0 red-circle btnLamp_lite"
          ...
          <div
            class="mt-0 yellow-circle btnLamp_lite"
          ...
          <div
            class="mt-0 pink-circle btnLamp_lite"
            v-else-if="getStatusData == 4"
            @click="redirect"
          >
            {{ name }} 計
          </div>
          <div class="mt-0 black-circle btnLamp_lite" v-else @click="redirect">
            {{ name }} 停
          </div>
        </v-row>
        <v-row>
          ...
          <v-col class="mt-0">
            <p class="HunByou_lite mt-0 mb-0 ml-0 pt-0 pb-0" :style="Beki2"
              >{{ CycleJustHunByou }}
              </p>
                ...
                <p
                  class="green--text mt-3 mb-0  ml-1 pb-0 text-right text--lighten-1 font-weight-bold text-h9"
                >
                  {{ getCountData }}台
                </p>
                <p
                  class="SensingTime  my-0 mx-0 py-0"
                  >{{ getSensingStTime }}~ 
                </p>
      
      
                <!-- <p
                  class="green--text my-0 ml-1 text-right text--lighten-1 font-weight-bold text-h9"
                >
                  {{ calcMachineRate }}%
                </p> -->
        ...
        <span width="200px" height="500px">
          <v-row class="mt-0 ml-2 pa-0">
              <p
                class="mt-1 mb-3 mr-5 text-center text--lighten-1 font-weight-bold ObjStyleA_lite"
                v-bind:style="Beki"
              >
                BDR {{ calc_BekiDouRitsu }}%({{
